...
```
~/.openclaw/skills/podcast-gen/scripts/transcribe.py    # Whisper 转录
...
```bash
nohup ~/.openclaw/skills/podcast-gen/.venv/bin/python3 \
  ~/.openclaw/skills/podcast-gen/scripts/transcribe.py \
  --file "{本地路径}" \
